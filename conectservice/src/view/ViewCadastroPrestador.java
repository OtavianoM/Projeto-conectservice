...
import model.dao.CadastroPrestador;

/**
 *
 * @authores Amanda, Cristovão, Dinah, Felipe, Marcelo e Otaviano 
 */
public class ViewCadastroPrestador extends javax.swing.JFrame {

    /**
     * Creates new form ViewCadastroPrestador
     */
    public ViewCadastroPrestador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("CADASTRO DO PRESTADOR DE SERVIÇO");
        ...
        jLabel8.setText("Digite sim");

        jLabel9.setText("Tipo de serviço? exemplo: Pintura");
        ...
        jLabel11.setText("Valor do seu serviço");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtPrestador, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(txtServico, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastroActionPerformed
        ...
        PrestadorServico use = new PrestadorServico();
        CadastroPrestador usu = new CadastroPrestador ();

        use.setNome(txtNome.getText());
        use.setCnpj((txtCNPJ.getText()));
        use.setLoginprestador(txtLogin.getText());
        use.setSenhaprestador((txtSenha.getText()));
        use.setAtuacao(txtServico.getText());
        use.setValor(txtValor.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCadastroPrestador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
